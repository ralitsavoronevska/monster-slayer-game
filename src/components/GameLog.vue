<template>
  <div
    class="@container bg-white dark:bg-gray-700 rounded-lg p-4 mt-6 max-h-64 overflow-y-auto"
  >
    <h2
      class="text-lg font-bold text-center mb-3 text-gray-700 dark:text-gray-300"
    >
      Battle Log
    </h2>
    <div
      v-if="messages.length === 0"
      class="text-center text-gray-700 dark:text-gray-300 text-sm"
    >
      No actions yet...
    </div>
    <div v-else>
